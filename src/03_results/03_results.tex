...
\begin{proof}
  ...
  the diligent reader. Fix $(x_1,x_2), (y_1,y_2), (z_1,z_2) \in \inter[L]$:
  \begin{itemize}
    \item Suppose that $(x_1,x_2) \before (y_1,y_2)$, so $x_1 < x_2 < y_1 < y_2$. If
      $(y_1,y_2) \aiaarrow{<mos} (z_1,z_2)$ then in all cases we must have
      $y_1 \leq z_1$, hence $x_1 < x_2 < z_1 < z_2$ and $(x_1,x_2) \before (z_1,z_2)$. On the other
      hand, if $(y_1,y_2) \aiaarrow{fd} (z_1,z_2)$ then we have $z_1 < y_1 \leq z_2$. This means
      that $x_2 < z_2$, restricting the possible relations between $(x_1,x_2)$ and $(y_1,y_2)$ to
      $(x_1,x_2) \aiaarrow{<mosd} (z_1,z_2)$ as expected.
    \item Suppose that $(x_1,x_2) \meets (y_1,y_2)$ so $x_1 < x_2 = y_1 < y_2$. If
      $(y_1,y_2) \aiaarrow{<mo} (z_1,z_2)$ then in all cases we must have $y_1 < z_1$ implying that
      $(x_1,x_2) \before (z_1,z_2)$. If $(y_1,y_2) \starts (z_1,z_2)$ then $y_1 = z_1 < z_2$ and
      $(x_1,x_2) \meets (z_1,z_2)$ too. Finally, if $(y_1,y_2) \aiaarrow{fd} (z_1,z_2)$ AAAA
  \end{itemize}
